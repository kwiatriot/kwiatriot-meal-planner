...
// Evaluated at build time on the client bundle — hides the UI when unset.
// Server-side re-check in actions.ts blocks any direct endpoint calls.
          ...
          <p className="text-center text-sm text-gray-500">
            {mode === 'signin' ? (
              ...
              <>
                ...
                <button onClick={() => { setMode('signin'); setError(null) }} className="text-blue-600 hover:underline">
                  Sign in
                </button>
              </>
            )}
